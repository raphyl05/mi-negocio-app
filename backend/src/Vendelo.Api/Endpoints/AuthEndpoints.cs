...
public static class AuthEndpoints
{
        ...
        CancellationToken ct)
    {
        ...
        var email = req.Identifier.Contains('@') ? req.Identifier : null;
        var phone = email is null ? req.Identifier : null;
    ...
    private static Task<IResult> RecoverAsync(RecoverRequestDto? req, CancellationToken ct)
    {
        ...
        return Task.FromResult((IResult)Results.Ok(new { message = "Si la cuenta existe, recibirás un mensaje de recuperación." }));
    }
